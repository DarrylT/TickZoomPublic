...
{
	public struct PhysicalOrder {
		private OrderType type;
		private double price;
		private double size;
		private object brokerOrder;
		
		public PhysicalOrder(LogicalOrder logical, double size, object brokerOrder) {
		...
		public PhysicalOrder(OrderType type, double price, double size, object brokerOrder) {
			this.type = type;
			this.price = price;
			this.size = size;
			this.brokerOrder = brokerOrder;
