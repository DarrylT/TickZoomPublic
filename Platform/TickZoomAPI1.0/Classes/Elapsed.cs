...
namespace TickZoom.Api
{
	...
	public struct Elapsed : IEquatable<Elapsed>
	{
		...
		public int Hours {
			get { return (int) ( (elapsed * HoursPerDay) % HoursPerDay); }
		}
		
		public int Minutes {
			get { return (int) ( (elapsed * MinutesPerDay) % MinutesPerHour); }
		}
		
		public int Seconds {
			get { return (int) ( (elapsed * SecondsPerDay) % SecondsPerMinute); }
		}
